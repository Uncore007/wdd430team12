  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="tabs mb-6">
        <button 
          className={`tab tab-lifted ${activeTab === 'products' ? 'tab-active' : ''}`}
      ...
      {activeTab === 'profile' && (
        <div className="bg-base-100 rounded-box p-6 shadow-lg">
          ...
          <form className="space-y-4">
            {/* Seller story/bio section */}
            <div className="form-control">
              <label className="label">
                <span className="label-text">Your Story / Bio</span>
              </label>
              <textarea className="textarea textarea-bordered h-32" placeholder="Share your craftsmanship journey..."></textarea>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="form-control">
                <label className="label">
              ...
              <div className="form-control">
                ...
                <input type="text" className="input input-bordered" value="Artisan" disabled />
              </div>
            </div>
            <div className="form-control">
              <label className="label">
